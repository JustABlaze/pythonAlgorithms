...
def SA_Algorithmpa(xInput, yInput, a, b, c, d, e):
    ...
    for i in range(0, 450):
        for i in range(200):
            ...
            if objectiveFuncparallel(x, y, a, b, c, d,
                                     e) <= objectiveFuncparallel(
                                         prevX, prevY, a, b, c, d, e):
                prevX = x
                prevY = y
            else:

                if random.uniform(0, 1) <= math.exp(-(
                    (objectiveFuncparallel(x, y, a, b, c, d, e) -
                     objectiveFuncparallel(prevX, prevY, a, b, c, d, e)
                     ) / startingTemp)):
    ...
    return (f"Final Result: {round(finalResult,4)}",
            f"X Coord: {round(finalX,6)}", f"Y Coord: {round(finalY,6)}")
...
for i in range(0, array.__len__()):
    ...
    print(
        SA_Algorithmpa(3, 2, array[i][0], array[i][1], array[i][2],
                       array[i][3], array[i][4]))
